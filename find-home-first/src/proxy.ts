 ...
 *
 * Resume navigation is handled by /housing-search/resume itself. The proxy must
 * not infer resume intent from Referer because redirects can preserve the
 * original Referer and create a /resume <-> /housing-search loop.
 */
