...
export const metadata: Metadata = { title: "Back Office — Billing Support" };
export const dynamic = "force-dynamic";

const UUID_RE = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;

interface BillingSupportPageProps {
...
export default async function BillingSupportPage({ searchParams }: BillingSupportPageProps) {
    ...
    <div className="max-w-5xl mx-auto px-5 py-8 lg:px-8">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between mb-8">
        ...
        <div className="text-sm sm:text-right" style={{ color: "var(--color-text)", opacity: 0.65 }}>
          ...
          <p className="text-xs mt-1">Back Office</p>
        </div>
      </div>
